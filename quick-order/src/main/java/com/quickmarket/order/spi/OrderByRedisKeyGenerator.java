package com.quickmarket.order.spi;

import com.quickmarket.order.QuickOrderApplication;
...
public class OrderByRedisKeyGenerator implements ShardingKeyGenerator {
    ...
    public Comparable<?> generateKey() {
        ...
        RedisOpsUtil redisOpsUtil = QuickOrderApplication.getBean("redisOpsUtil");
