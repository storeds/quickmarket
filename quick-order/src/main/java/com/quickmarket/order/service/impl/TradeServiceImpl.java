...
import com.quickmarket.order.component.trade.alipay.model.ExtendParams;
import com.quickmarket.order.component.trade.alipay.model.GoodsDetail;
...
import com.quickmarket.order.component.trade.alipay.service.impl.AlipayTradeServiceImpl;
import com.quickmarket.order.component.trade.alipay.utils.Utils;
import com.quickmarket.order.component.trade.alipay.utils.ZxingUtils;
...
public class TradeServiceImpl implements TradeService {
    ...
    private String aliPayQrCode(OmsOrderDetail orderDetail){
        ...
        String outTradeNo = (orderDetail.getId()+ 200) +"";
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl(tradePayProp.getPaySuccessCallBack()+"/1")
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                log.info("网络地址:{}", tradePayProp.getAliPayPath());
