...
public class OmsCartItemServiceImpl implements OmsCartItemService {
    ...
    public int add(OmsCartItem cartItem,Long memberId,String nickName) {
        ...
        if (existCartItem == null) {//创建购物车
            ...
            CartProduct cartProduct = pmsProductFeignApi.cartProductBySku(cartItem.getProductId(), cartItem.getProductSkuId()).getData();
            ...
            cartItem.setPrice(cartProduct.getSkuStockList().get(0).getPrice());
            //遍历产品sku，设置购买规格
            cartProduct.getSkuStockList().stream().forEach((skuItem)->{
                if(cartItem.getProductSkuId() == skuItem.getId()){
                    ...
                    cartItem.setProductAttr(skuItem.getSpdata());
                }
            });
    ...
    private OmsCartItem getCartItem(OmsCartItem cartItem) {
        ...
        OmsCartItemExample.Criteria criteria = example.createCriteria().andMemberIdEqualTo(cartItem.getProductId())
