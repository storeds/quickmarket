...
import com.quickmarket.admin.dto.UpdateAdminPasswordParam;
import com.quickmarket.common.api.CommonPage;
import com.quickmarket.common.api.CommonResult;
import com.quickmarket.admin.dto.UmsAdminLoginParam;
import com.quickmarket.admin.dto.UmsAdminParam;
import com.quickmarket.common.domain.UserDto;
import com.quickmarket.mbg.model.UmsAdmin;
import com.quickmarket.mbg.model.UmsPermission;
import com.quickmarket.mbg.model.UmsRole;
...
public class UmsAdminController {
    ...
    public CommonResult login(@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        ...
        adminService.updateLogin(umsAdminLoginParam.getUsername());
    ...
    @ResponseBody
    public CommonResult updatea(@RequestHeader("memberId") Long id, @RequestBody UmsAdmin admin) {
        int count = adminService.update(id, admin);
        if (count > 0) {
            return CommonResult.success(count);
        }
