package com.quickmarket.search.service.impl;

import com.alibaba.fastjson.JSON;
import com.quickmarket.search.domain.EsProduct;
import com.quickmarket.search.repository.EsProductRepository;
import com.quickmarket.search.service.QuickMallSearchService;
import com.quickmarket.search.util.SearchConstant;
 ...
 * @program: quickmarket
 * @author: cx
 * @create: 2022-02-21 22:30
 * @description:
 **/
@Service
public class QuickMallSearchServiceImpl implements QuickMallSearchService {
    ...
    private SearchRequest startBuildRequestParam(ESRequestParam param) {
        ...
        if (!StringUtils.isEmpty(param.getKeyword())) {
            ...
            highlightBuilder.preTags("<b style='color:#0499FD'>");
