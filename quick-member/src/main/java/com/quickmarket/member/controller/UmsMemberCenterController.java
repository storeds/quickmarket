...
@Api(tags = "UmsMemberCenterController",description = "会员中心管理操作添加")
@RestController
...
public class UmsMemberCenterController {
    ...
    @ApiOperation(value = "获取会员信息添加",notes = "不包含会员等级信息,会员需要被拆分成微服务")
    ...
    @ApiOperation(value = "获取会员详细信息包含会员等级信息添加",notes = "会员需要被拆分成微服务")
    ...
    @ApiOperation(value = "修改个人信息添加",notes = "会员需要被拆分成微服务")
