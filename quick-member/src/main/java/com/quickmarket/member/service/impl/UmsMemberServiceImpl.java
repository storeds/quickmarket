...
import com.quickmarket.common.api.TokenInfo;
import com.quickmarket.member.constant.MDA;
import com.quickmarket.mbg.mapper.UmsMemberLevelMapper;
import com.quickmarket.mbg.mapper.UmsMemberMapper;
import com.quickmarket.mbg.model.UmsMember;
import com.quickmarket.mbg.model.UmsMemberExample;
import com.quickmarket.mbg.model.UmsMemberLevel;
import com.quickmarket.mbg.model.UmsMemberLevelExample;
import com.quickmarket.member.service.RedisService;
import com.quickmarket.member.service.UmsMemberService;
import com.quickmarket.member.util.EmailUtile;
...
public class UmsMemberServiceImpl implements UmsMemberService {
    ...
    public CommonResult register(String username, String password, String telephone, String authCode) {
        String key = telephone + "@qq.com";
        //验证验证码
        if(!verifyAuthCode(authCode,key)){
        ...
        UmsMember umsMembers = memberMapper.selectName(username);
        if (umsMembers != null) {
    ...
    public CommonResult generateAuthCode(String telephone) throws Exception {
        ...
        EmailUtile emailUtile = new EmailUtile();
        emailUtile.SendEamil(sb.toString(), telephone);
        // 添加成功后向邮箱发送消息
